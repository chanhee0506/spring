...
<html lang="ko">
  <head>
    ...
    <link rel="stylesheet" href="./resources/register/registerForm.css"/>   
      ...
      <header>
        ...
        <div class="wrapper">
          ...
          <form:form modelAttribute="user">
            <div class="Id">
              <input type="text" id="id" title="ID" maxlength="15" style="border: 2px solid gray; border-radius: 5px;" placeholder="아이디 입력" required pattern="^[a-zA-Z0-9]+$" name="id" class="id_input" >
            ...
            <div class="password">
              <input type="password" id="password" title="PW" maxlength="20" style="border: 2px solid gray; border-radius: 5px;"  placeholder="비밀번호 입력" required pattern="^(?=.*[A-Za-z])(?=.*\d)(?=.*[$@$!%*#?&])[A-Za-z\d$@$!%*#?&]{8,}$" name="pwd">
       ...
       $(document).ready(function() {        	
          ...
          $("#name").on("blur",function(){
              ...
              <div class="name">
                <input type="text" id="name"  maxlength="10" style="border: 2px solid gray; border-radius: 5px;" placeholder="이름" name="name" required pattern="^[가-힣]{2,6}$" >
                ...
                <div class="nname">
                  <input type="text" id="nname" name="nickname" title="NNM" maxlength="10" style="border: 2px solid gray; border-radius: 5px;" placeholder="닉네임" required pattern="^(?=.*[a-z0-9가-힣])[a-z0-9가-힣]{2,8}$">
                </div>
                <div class="email">
                 <input type="email" id="email" name="email" title="EM" maxlength="20" style="border: 2px solid gray; border-radius: 5px;" placeholder="이메일" >
                 <span>
