...
<html lang="ko">
  <head>
    ...
    <script src="../resources/js/login/jquery-3.6.1.min.js"></script>
      ...
      <header>
        ...
        <div class="wrapper">
          ...
          <form method="post" id="membership">
            <div class="Id">
              <input type="text" id="id" title="ID" maxlength="15" style="border: none;" placeholder="아이디 입력" required pattern="^[a-zA-Z0-9]+$" name="memberId">
        ...
        $(document).ready(function(){
        	...
        	$(".join_button").click(function(){
        		$("#membership").attr("action", "/ottt/login/join");
        		$("#membership").submit();
        	});
        });
        </script>
